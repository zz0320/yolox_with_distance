...
# /Users/kenton/miniforge3/envs/openmmlab/lib/python3.8/site-packages/mmdet/core/evaluation/class_names.py
"""voc_classes = [
        '左前', '左后', '右前', '右后', '前侧', '后侧', '左侧', '右侧'
    ]"""
...
def parse_args():
    ...
    parser.add_argument('-o', '--out-dir', default='/Users/kenton/Downloads/集群重点研发/蝠鲼数据集/蝠鲼COCO/', help='output path') # '-o',
    parser.add_argument(
        '--out-format',
        default='coco',
        choices=('pkl', 'coco'),
